...
for ( i in as.character(1996:2000)) {
...
precip.df<-do.call(cbind, precip.ls)
...
precip.df<-data.frame(rain.grid.index=rain.pixels@grid.index, mean.ann.rain.5yr=precip.df)
